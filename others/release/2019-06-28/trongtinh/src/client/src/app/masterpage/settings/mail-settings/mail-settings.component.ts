...
export class MailSettingsComponent implements OnInit {
    ...
    constructor(private mailSettingsService: MailSettingsService, private router: Router, public snackBar: MatSnackBar, private sharedService: SharedService, public dialog: MatDialog) {
    ...
    prepareDate() {
        ...
        console.log(this.formSettingMail.secure)
    }
    ...
    updateFormMailSetting() {
        // Chuan bi data, lay data tu form
        this.prepareDate()
